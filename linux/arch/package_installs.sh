...
sudo pacman -S lsd bat fd fzf jq git-delta zoxide ripgrep cargo neovim git starship fastfetch github-cli stow zsh which alacritty openssh ghostty man-db tldr npm nodejs wget tmux # htop duf
...
if full_install; then
    sudo pacman -S hyprland waybar hypridle hyprpicker hyprlock hyprpolkitagent swaync xdg-desktop-portal-hyprland xdg-desktop-portal-gtk wofi wireplumber pipewire wl-clipboard flatpak gnome-themes-extra grim networkmanager noto-fonts noto-fonts-emoji firefox nautilus gdm adw-gtk-theme mpv fcitx5-anthy wine gamemode mangohud gamescope xdg-utils
    ...
    # Yay installs
    yay -S brave-bin steam-devices goxlr-utility ocrmypdf 
